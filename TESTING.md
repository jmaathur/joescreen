...
swift test      → Executed 224 tests, 7 skipped (integration + capture-TCC), 0 failures
                  (120 pre-M9 + 75 M9 Tier-1 + 29 M10 Tier-1: TrackClassifier 7, DevTokenMinter 4,
                  ParticipantMediaReducer 9, TileSubscriptionPlanner 9)
```
