...
swift test      → Executed 266 tests, 7 skipped (integration + capture-TCC), 0 failures
                  (120 pre-M9 + 75 M9 + 29 M10 + 42 M11 Tier-1: ShareContext 10, ShareBitratePolicy 5,
                  AdmissionOverload 5, DisplayPickResolver 6, DisplayResolutionPolicy 7,
                  RenegotiationDecision 7 + 2 net lifecycle additions)
```
